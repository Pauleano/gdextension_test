...
- "there's a code-judo move here that makes this much simpler"
...
Do not spend the review on low-value nits when major structural issues exist.
...
- The PR adds an unnecessary abstraction, wrapper, or cast-heavy contract making design more indirect.
- The PR duplicates an existing helper or puts logic in the wrong layer when a clear canonical home exists.

Unless the author provides a clear justification, treat these as blocking.
