...
Data flows: Godot CameraServer frame → GDScript worker thread → C++ OpenCV detection → camera-space marker poses → baked to world space using the head pose at capture time.
